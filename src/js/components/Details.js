        ...
        <div className="container">
          <div className="row mb-5">
            ...
            <div className="col-md-6">
              <p className="lead">Krowd empowers you to raise money for anything that matters to you. From personal causes and events to projects and more. We’ve helped people from all over the world raise millions online.</p>
          ...
          <div className="row mt-5">
              ...
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <h3 className="block-38-heading">Umang Gupta</h3>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <h3 className="block-38-heading">Dheeraj Saraogi</h3>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <h3 className="block-38-heading">Vanshika Tyagi</h3>
