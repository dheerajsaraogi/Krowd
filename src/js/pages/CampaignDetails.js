      ...
      if (this.state.contributionAmtInput > this.state.minContribution) {
        this.state.campaignInstance
          .contribute({
            ...
            value: web3.toWei(this.state.contributionAmtInput , 'ether')  ,
            gas: 4712388,
        ...
        alert(`Enter minimum contribution amount greater than ${this.state.minContribution} `)
      }
    } catch (error) {
